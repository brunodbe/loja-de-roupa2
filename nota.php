...
<body>
    ...
    <div class="container mt-5  ">
        <div class="folha dobra">
            ...
            <div class="mt-1">
                <h4>Nome do cliente:</h4><span>Bruno Fernandes</span>
            </div>
            <h5>CPF/CNPJ:</h5><span>000.123.654-00</span>
            <h5>Nº Pedido:</h5><span>005</span><br>
            ...
            <div class="form-group mt-2 col-1">
                ...
                <input class="btn btn-primary mt-2" type="button" onclick="funcao1()" value="Imprimir" />
            </div>
            <script>
                function funcao1() {
