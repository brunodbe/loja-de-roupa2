...
<body>
    ...
    <div class="container mt-5">
        ...
        <button class="text-center btn btn-success"><i class="fa fa-file-archive-o" aria-hidden="true"><a
                    href="relatorio.html">&nbsp Baixar</a> </i></button>
    </div>
